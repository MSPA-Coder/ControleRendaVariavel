...
ENDPOINTS_DE_ADMIN = frozenset(
    {
        ...
        "portfolio.create_broker",
        "portfolio.update_broker",
        "portfolio.delete_broker",
        "portfolio.activate_broker",
        "portfolio.create_ticker",
        "portfolio.update_ticker",
        "portfolio.delete_ticker",
        "portfolio.activate_ticker",
        "portfolio.create_quote_history_entry",
        "portfolio.import_quote_history",
        "portfolio.import_position_quote_history",
        "portfolio.delete_quote_history_by_date",
        "options.table_expirations",
        "options.create_expiration",
        "options.delete_expiration",
        "options.update_expiration",
        "options.table_contracts",
        "options.create_contract",
        "options.delete_contract",
        "options.update_contract",
        "users.index",
        "users.create",
        "users.edit",
