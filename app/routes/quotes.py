...
from app.positions.average_cost_line import linhas_de_custo_medio_do_ticker
...
def _quote_history_context(
    *,
    ...
    average_cost_lines = (
        linhas_de_custo_medio_do_ticker(selected_ticker.id, current_owner_id())
        if selected_ticker
        else []
    )
    ...
    return {
        ...
        "history": history,
        "average_cost_lines": average_cost_lines,
